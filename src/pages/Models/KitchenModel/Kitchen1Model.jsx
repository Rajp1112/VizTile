...
import dinning from '/assets/GLBModel/dining_room__kichen_baked.glb';
...
export function Kitchen1Model(props) {
  const { nodes, materials } = useGLTF(dinning);

  const texture = useTexture(props.selectedImage || floorTexture1);
  const texture2 = useTexture(props.selectedImage2 || floorTexture1);

  const wallTexture1 = useTexture(props.selectedWallImage || floorTexture1);
  const wallTexture2 = useTexture(props.selectedWallImage2 || floorTexture1);
  return (
